"""Chapter 31: Pagination with Link headers and X-Total-Count."""
import sys
sys.path.insert(0, ".")
...
app = FastAPI(title="Mini-GitHub", version="1.1.0")
...
def list_user_repos(
    ...
    link = build_link_header(request, page, per_page, total)
    if link:
