...
class GitHubClient:
    ...
    - Default timeout=(5, 30) applied to every request.
    - Supports context manager protocol (with GitHubClient() as client:).
    - close() method releases the session's connection pool.
    """
