"""Chapter 36: The server under test (same as ch32_auth stage).
...
app = FastAPI(title="Mini-GitHub", version="1.6.0")
...
def create_repo(
    username: str, repo_in: RepoCreate, request: Request, response: Response,
